...
ruby pipeline/bin/route53switch.rb  --subdomain honolulu --hostedzone $domain --region $region --stackname $production_stack_name
ruby pipeline/bin/route53switch.rb  --subdomain appdemo --hostedzone $domain --region $region --stackname $production_stack_name
