...
def pipelines =  [
  "Continuous Delivery Pipeline":[
    ...
    "capacity" : ["performance-testing", "load-testing","chaos-testing", "penetration-testing", "launch-environment-capacity"],
...
pipelines.each { pipeline, stages ->
  ...
  // the data structure we define the pipelines in is useful for humans to read, but a pain to look-forward through. Translate to something easier to code around.
    ...
    job {
      ...
      publishers {
        extendedEmail("paul.duvall@stelligent.com", "\$PROJECT_NAME - Build # \$BUILD_NUMBER - \$BUILD_STATUS!", """\$PROJECT_NAME - Build # \$BUILD_NUMBER - \$BUILD_STATUS:
